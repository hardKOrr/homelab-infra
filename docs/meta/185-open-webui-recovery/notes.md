...
- Evidence output carries no backup contents, credential values, endpoint values or live configuration. `live_verified` remains `false`; schedule firing, installed version/digest, PBS identity/age/integrity and live application results are deferred to #80.
