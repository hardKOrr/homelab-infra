...
**Related:** [closed catalog issue #408](https://github.com/hardKOrr/homelab-infra/issues/408), [observation issue #238](https://github.com/hardKOrr/homelab-infra/issues/238)
...
- [x] Synthetic fixture verification renders the Compose file against a named music
      ...
      or live PBS restore.
- [ ] Live evidence is deferred to the self-contained [observation issue #238](https://github.com/hardKOrr/homelab-infra/issues/238). Proposed
      disposable target: instance `navidrome-acceptance` on stack host
      `stack-media-acceptance`. Before execution #238 must authorize and record the exact
