...
| 3 | [602 — Rundeck job tree](602-rundeck-job-tree/README.md) | Catalog-first nested tree: applications by purpose/type/name; platform, management, recovery and setup by truthful operator intent. Canonical classification is validated before import; job names, UUIDs, steps, options and schedules stay unchanged | [x] |
