...
**14 live · 46 archived in [done/](done/) · 3 unreachable in [no-target/](no-target/).**
...
| 3 | [602 — Rundeck job tree](done/602-rundeck-job-tree/README.md) | Phase 2 built 2026-08-23: one folder per application, its Deploy job and a generated Maintenance folder; per-application expansion of eight day-2 templates; a live instance dropdown; Restart and Tail extended to Docker apps. Awaiting two **Reimport Jobs** runs on the live runner | [ ] |
...
| Order | Slice | Repository work | Complete |
|---:|---|---|:---:|
| 1 | [413 — Odoo CRM](413-odoo-crm/README.md) | Odoo Community CRM on a separately deployed PostgreSQL instance; preserve the filestore with the database and keep unrelated ERP modules operator-selected | [ ] |
