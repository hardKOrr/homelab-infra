...
`nvidia-smi` and the Ollama `/api/tags` endpoint. Live execution is deferred to the isolated
real-Proxmox acceptance lane; repository fixtures and synthetic checks are the closure
