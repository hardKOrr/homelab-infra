...
|---|---|---|
| 1 | The browser legs, in one sitting at a browser: turn off `allowAdminAccessToAllCollectionItems` and re-run a deploy, Vaultwarden vault CRUD, Grafana and Authentik sign-in, one app behind `forward_auth`. | 016, 400, 403, 405, 306 |
