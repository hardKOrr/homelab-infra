...
- `ansible/scripts/secret-shape.py` and `tasks/bootstrap/write-generated-facts.yml`
- `.claude/gate/test-vaultwarden.sh` — redaction, mapping, fail-closed and cleanup tests
