...
- Verification beyond the gate is stated per-specimen: hand-computed worked examples plus optional
  ad-hoc localhost plays. Record it in the specimen's design under `.isotope/cultures/`.
